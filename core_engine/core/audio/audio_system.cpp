...
namespace CoreEngine {
    ...
    bool AudioSystem::Resume() const { return backend_ != nullptr && backend_->Resume(); }

    bool AudioSystem::Pause() const { return backend_ != nullptr && backend_->Pause(); }
    ...
    int AudioSystem::QueuedBytes() const { return backend_ != nullptr ? backend_->QueuedBytes() : 0; }
